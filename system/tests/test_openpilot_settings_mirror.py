...
# Repo root (this file lives at system/tests/test_openpilot_settings_mirror.py).
...
_SOURCE_ROOTS = ("selfdrive/ui/layouts/settings", "selfdrive/ui/widgets", "dragonpilot/dashy")
