...
procs = [
  ...
  PythonProcess("pandad", "selfdrive.pandad.pandad", always_run, enabled=not TICI_DOS),
  PythonProcess("pandad", "selfdrive.pandad_tici.pandad", always_run, enabled=TICI_DOS),
